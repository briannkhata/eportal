<?php $this->load->view('header');?>
									...
									<form action="<?=base_url();?>slip/upload_slip" method="post" enctype="multipart/form-data">
													<div class="col-md-12">
                                                         <div class="form-group">
                                                            <label class="control-label">Select Slip</label>
														...
														<div class="form-group">
														  <label for="exampleInputEmail1">Staff</label>
														    <select name="user_id" class="form-control">
														    	<option selected="" disabled=""> Option </option>
														       <?php foreach($this->db->get('tblusers')->result_array() as $yo):?>
